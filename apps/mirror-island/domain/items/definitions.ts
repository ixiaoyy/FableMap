...
export const ITEM_DEFINITIONS: Readonly<Record<ItemId, ItemDefinition>> = {
  ...
  [ITEM_ID.pickaxe]: { id: ITEM_ID.pickaxe, name: "基础镐", category: "tool", maxStack: 1, hotbarMark: "镐" },
  [ITEM_ID.scythe]: { id: ITEM_ID.scythe, name: "基础镰刀", category: "tool", maxStack: 1, hotbarMark: "镰" },
  [ITEM_ID.stone]: { id: ITEM_ID.stone, name: "石料", category: "resource", maxStack: 99, hotbarMark: "石" },
  [ITEM_ID.fiber]: { id: ITEM_ID.fiber, name: "植物纤维", category: "resource", maxStack: 99, hotbarMark: "纤" },
