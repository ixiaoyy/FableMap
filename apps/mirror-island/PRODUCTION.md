...
2. 构建 Phaser/Vue frontend、Colyseus game 和 migration 三个镜像，检查 browser 不含 Prisma/pg/secret、runtime 不含 Prisma CLI。
...
6. 替换 frontend 并验证根入口、OIDC discovery、Keycloak discovery、Colyseus matchmaking 和 WebSocket health。
