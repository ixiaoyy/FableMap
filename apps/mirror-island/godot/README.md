...
菜单中的生活技能可查看种植、采集、采矿的经验与等级；对应劳动升级后减少工具耗能，日结记录可随存档恢复。土豆已采用基础额外产出几何分布。当前封套 8 / 状态 20；配方、职业、钓鱼经验和每日运气仍待接入，详见 [S2-A 验证记录](../../../.trellis/tasks/09-04-skills-recipe-unlocks-v1/verification-s2a.md)。
