...
当前版本已实现春季基础玩法 v10：午夜提醒、02:00 昏倒、体力与天气、自由耕地、水壶补水、六作物、资源再生、钓鱼和送礼。相关自动检查通过，真人验收已由用户于2026-09-03确认全部完成；部署结果以 main 发布流水线为准，详见 [当前状态](docs/CURRENT_STATE.md)。

工作区另已实现首批春季美术精修：自家小屋木作与陈设、25 个物品的统一图标，以及保留原角色外观的种田动作。存档仍为 v10；本批真人审美与手感验收、发布尚未进行。

第二批种子店与铁匠铺也已完成本地精修，补齐种子柜台/货架与锻炉/铁砧/工具架，并修正了门口切图黑屏问题。两处场景已核对桌面、手机、交易、查看和往返；尚未部署。
