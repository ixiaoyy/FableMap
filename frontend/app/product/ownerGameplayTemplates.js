...
export const OWNER_GAMEPLAY_TEMPLATES = [
  ...
  {
    id: 'orphan-signal-echo',
    category: '文游',
    badge: '终端',
    title: '孤信号：回响协议',
    duration: '8-15 分钟',
    bestFor: '占卜密室、废墟遗址、老旧街角、信号观测塔',
    entryLabel: '接入回响协议',
    summary: '高沉浸终端式玩法：调频、采集碎片、修复这段坐标背后的历史回响。',
    goal: '引导访客扮演信号观测员，通过调频（选择）和解码（输入）还原一段与当前真实坐标相关的往事。',
    tone: '冰冷终端感、带有一点点科幻忧郁、专业术语化。',
    materials: ['加密频率', '波形图', '历史碎片 [Frag-A/B]', '记忆档案库'],
    rewardText: '信号同步成功。这段回响已存入本地归档，该坐标的频谱不再是空白。',
    nodes: [
      {
        id: 'start',
        title: '频率搜索',
        prompt: '初始化 FM-OS 1.0 终端。检测到坐标有微弱干扰，请访客选择一种扫描模式：全频谱扫描或定向波段锁定。',
        choices: [
          { id: 'full_scan', label: '全频谱扫描 (Wide Scan)', next_node_id: 'tuning' },
      ...
      },
      {
        id: 'tuning',
        title: '信号调频',
        prompt: '波形开始浮动。描述一处与空间环境相关的模糊视觉或听觉片段，并要求访客通过输入一个关键词（如“调优”或描述看见的细节）来稳定信号。',
        choices: [
      ...
      { id: 'complete', title: '信号归档', prompt: '显示归档成功代码。用一句带有宿命感的话总结这次回响采集，并提醒信号已永久记录。', choices: [] },
    ],
  },
  {
    ...
    entryLabel: '开始证据重构',
    summary: '引导访客通过询问不同嫌疑人和搜证，拼凑出完整的证据链。',
    goal: '帮助访客理清时间线，找出 2 个关键证言矛盾。',
    tone: '冷静、悬疑、追问细节。',
  ...
  },
  {
    ...
    entryLabel: '开启逻辑对跳',
    summary: '模拟狼人杀白天讨论环节，进行身份辨析与站边博弈。',
    goal: '通过分析两名对跳玩家的发言，找出漏洞并决定投票去向。',
    tone: '激烈、多疑、逻辑驱动。',
  ...
  },
  {
    ...
    bestFor: '弄堂口、茶馆、邻里中心',
    entryLabel: '入座搓两把',
    summary: '边打麻将边聊家常，是获取坐标周边“隐秘八卦”的最好方式。',
    goal: '在打牌过程中，通过 3 轮闲聊挖掘出 1 条关于该坐标的历史趣闻。',
    tone: '随和、市井、充满生活气息。',
    ...
    nodes: [
      ...
      },
      {
        id: 'reveal',
        title: '旧事揭秘',
        prompt: 'NPC 讲完完整的坐标故事。请访客在“回访便签”上记录下这段回响。',
  ...
  },
  {
    ...
    goal: '通过三轮抽牌选择，让荷官对访客进行一次精准的心理侧写。',
    tone: '沉稳、优雅、富有哲理。',
