...
- Desktop home uses `reference/soullink-index-1536x1024.png` as the owner-approved SoulLink artboard until a DOM rebuild is explicitly requested.
...
- Do not add loose `main.png`, `right-rail.png`, `sidebar.png`, or `*-2x.png` screenshot slices back under retired theme folders.
