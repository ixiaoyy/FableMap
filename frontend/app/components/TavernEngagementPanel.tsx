...
type TavernEngagementPanelProps = {
  tavern: Tavern
  currentUserId: string
}

export function TavernEngagementPanel({ tavern, currentUserId }: TavernEngagementPanelProps) {
  ...
  async function loadPanel() {
    ...
    try {
      const [nextConfig, nextProgress] = await Promise.all([
        getEngagementConfig(tavern.id, currentUserId),
        getVisitorEngagement(tavern.id, currentUserId),
      ])
