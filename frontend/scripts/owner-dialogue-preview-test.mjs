...
assert.match(component, /preview only/, 'simulator copy should show preview-only boundary')
assert.match(component, /不调用 LLM，不写入聊天历史 \/ 记忆 \/ writeback/, 'simulator copy should state no LLM/history/writeback')
