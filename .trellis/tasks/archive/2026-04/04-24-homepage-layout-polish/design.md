...
- Hero 左侧为大标题与 CTA；右侧为空间内景 + NPC 主人 banner。
- Hero 下方是 4 项横向数据指标条。
- 中段是 3 张带图片封面的精选空间卡。
...
- `frontend/app/routes/home.tsx` 已按设计稿落地为浏览器窗口外框、导航搜索、hero、指标条、热门空间卡、NPC 对话模块、记忆模块、底部价值条。
...
- 指标、热门空间、AI 对话、记忆、价值条拆成独立网页 section。
