...
探索一个高风险但有传播力的空间关系玩法：真人访客在满足条件后，可以与单个 NPC 建立 1 对 1 的长期/永久公开关系，并让该关系改变 NPC 对外身份，对其他用户可见。该功能不只服务“伴侣/婚配”，而是一个可扩展的 NPC 公开关系系统。
...
- `docs/WHAT_NOT_TO_BUILD.md` 禁止无边界访客社交、访客好友/私信/动态墙、绕过店主审批真人扮演；允许空间内、角色内、店主治理的受控关系。
...
- NPC 分两类治理来源：
  - 私人 / 店主空间 NPC：访客达成 close_friend 条件后提交申请，必须由该空间店主审批后才能改变 NPC 公开身份。
...
- 不做按性别 / 婚配状态的公开发现匹配。
- MVP 不做店主自定义关系类型、复杂名额配置或自定义规则 DSL，避免打破空间沉浸。
...
- 可以成为空间传播点：公开 NPC 卡片显示“已与某位访客结缘”，但不形成跨空间社交图。
