...
采用 **FableMap 自有的“暖木质空间”**：木桌、铜边、羊皮纸、烛火和手工招牌带来温暖空间情绪；真实地图坐标、记忆状态、运行时诊断用少量青色/紫色光表达。

可借鉴的是“亲切、厚重、手工空间”的氛围；不能复制任何具体游戏 UI、卡背、图标、字体、英雄、法力水晶、牌桌或卡牌对战语义。FableMap 的核心仍是：真实坐标 → 店主空间 → AI NPC → 记忆回访。
...
1. [发现空间 / Discovery](./01-discover-map.svg) — 真实地图锚点、附近空间列表、开店入口。
2. [空间入口 / Tavern Entry](./02-tavern-entry.svg) — 店主设定、访问规则、NPC 选择、入场承诺。
...
7. [NPC 形象风格投放 / NPC Style Cast](./07-npc-style-cast.svg) — 不同主题下的 NPC 形象占位、空间室内舞台和点击切换对话对象。
