...
为 FableMap 探索并构思一个新的核心功能，以增强产品的“真实地图”锚定与“空间 UGC”核心体验。

## What I already know

* 核心体验：探索真实地图上的虚拟空间，与配置了设定和记忆的 AI NPC 进行对话。
...
**1. AI 辅助空间生成向导 (AI-Assisted Tavern Drafts)**
* 根据店主选择的真实地理坐标（如大学、小吃街等），AI 辅助生成符合地理特征的空间设定草稿和初始 NPC 角色卡。
* 草稿由店主确认、修改后方可上线，遵循“主人主权”核心价值观。

**2. 街区传闻系统 (Neighborhood Rumor System)**
* 基于地理位置，自动向 NPC 注入附近的“街区传闻”。
* NPC 在对话中会提及附近的其他真实空间或事件，增加地图连通性和探索乐趣。

**3. 空间异步留言板 / 时间囊 (Tavern Guestbook/Time Capsule)**
* 允许访客在空间留下公开留言（地理坐标打卡等）。
