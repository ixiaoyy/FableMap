...
状态：completed。用户于 2026-09-02 批准实施；2026-09-03 恢复并完成代码及相关自动检查，随后要求提交推送 main。用户已确认真人验收全部完成，发布结果以流水线为准；详见 verification.md。
...
- [x] 人工验证新游戏、真实 v9 形状迁移、Day 1–7、24:00/02:00、三天气、自由农田、六作物、树再生、钓鱼、送礼、Day 28→29、刷新恢复、手机、键盘和 200% zoom。
