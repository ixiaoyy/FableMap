...
- Playwright sharpness audit added to `playwright-black-reference-check.mjs`: every visible runtime image is checked for raster upscaling on desktop and mobile.
- Search black card covers now render at the extracted asset height ratio (`51.34%`, 172px over the 335px card) instead of stretching 172px crops to 180px, removing a concrete blur source in search results.
