...
- Territory must remain anchored to real coordinates/taverns.
...
- Routes: `backend/src/fablemap_api/api/v1/territories.py`
...
- Validate coordinates and tavern identity.
...
- Do not leak private tavern config, visitor private memory, or owner secrets.
