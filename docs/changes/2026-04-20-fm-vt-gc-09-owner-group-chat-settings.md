...
GC-06 / GC-07 已提供酒馆级群聊配置 API，GC-08 已把访客聊天房间接入持久群聊；但店主还缺少可视化配置入口，无法在控制台调整群聊开关、角色接话积极度和发言策略。
...
- 群聊配置弹窗依赖 GC-06 / GC-07 的酒馆级配置 API；如果后端未同步该接口，保存会显示 API 错误。
