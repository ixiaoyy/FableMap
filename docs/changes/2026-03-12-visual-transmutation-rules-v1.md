...
- `python -m unittest tests/test_bundle.py tests/test_page.py tests/test_nearby.py tests/test_cli.py tests/test_demo.py tests/test_showcase.py`：17 个测试全部通过，零回归
