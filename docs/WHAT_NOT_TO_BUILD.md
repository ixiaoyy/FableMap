...
- 不恢复旧 React/Phaser 本地单机农场、RPGJS 运行时、`apps/api` FastAPI、旧 MySQL schema、旧媒体或隐藏回滚入口。
...
- 聊天、交易、组队、好友、排行榜、枪械、怪物潮、钓鱼、矿洞、节日和现金经济。
- 土地、作物或住宅周边公共格的私有化、保护、交易或 owner 权限。
- 玩家碰撞、公共住宅室内、多房屋、建筑材料和通用建造系统。
- 客户端权威位置/背包/掉落、第二套联机引擎、rollback、分布式 room、通用 ECS、大型全局状态库、地图编辑平台或无界程序生成框架。
