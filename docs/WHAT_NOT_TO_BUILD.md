...
- 当前世界拥有晨/昼/暮/夜色调及室内/室外强度差，八名 NPC 拥有十心基础好感/每日交谈/Social 名册、四段 anchor 日程、同区短路径/跨区淡入淡出、玩家/居民动态避让、白天轻量环境动作、线性对话、家庭/住址文本关系和 Seed Shop 白天营业。仍不加入路灯/点光源、推挤/穿人兜底、非白天复杂动作、完整日历、Season、天气、特殊日程优先级、跨地图连续寻路、送礼、私人内屋解锁、心事件、任务或复杂经济。
