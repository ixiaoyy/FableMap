...
2. [PRODUCT_BRIEF](PRODUCT_BRIEF.md) — 单人世界目标、玩法合同和成功标准。
3. [WHAT_NOT_TO_BUILD](WHAT_NOT_TO_BUILD.md) — 永久禁区与当前范围边界。
4. [IMAGE_ASSETS_SPEC](IMAGE_ASSETS_SPEC.md) — 开源素材许可、署名、CDN、manifest 和哈希合同。
...
9. [Town 后续开发路线图](TOWN_ROADMAP.md) — 已实现基线、明确延期能力、依赖顺序和后续任务触发条件。
10. [现阶段精细化验收门禁](CURRENT_SLICE_POLISH_GATE.md) — 功能、动作、地图、人物、交互、看板与 UI 的真实路线精细化门禁。
