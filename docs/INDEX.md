...
9. [Mirror Island Phaser 单人规范](../.trellis/spec/frontend/mirror-island-phaser-singleplayer.md) — 工程合同。
...
Character、StoryWorld、StoryRun、旧 React/Phaser 农场原型、LLM 和旧 FableSpace 数据库不再是当前文档或运行时的一部分。不要从 Git 历史恢复这些能力建立兼容层；当前 Phaser 4 单人农场继续作为唯一主线。
