...
from fablemap_api.core.cache import cache_path_for_request
from fablemap_api.core.overpass import OverpassError, fetch_overpass_data
...
class OverpassTests(unittest.TestCase):
    def test_fetch_uses_cached_payload_without_network_call(self) -> None:
        with TemporaryDirectory() as tmpdir:
            ...
            with patch("fablemap_api.core.overpass.urlopen") as urlopen_mock:
    ...
    def test_fetch_retries_after_transient_network_error(self) -> None:
        with patch("fablemap_api.core.overpass.time.sleep") as sleep_mock, patch(
            "fablemap_api.core.overpass.urlopen",
    ...
    def test_fetch_raises_clear_error_when_retries_are_exhausted(self) -> None:
        with patch("fablemap_api.core.overpass.urlopen", side_effect=URLError("dns failure")):
