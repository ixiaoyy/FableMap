...
DEFAULT_ROLES = [
    AgentRole(
        ...
        allowed_paths=["docs/", "backend/src/fablemap_api/core/", "tests/", "frontend/app/"],
        deliverables=[
    ...
    AgentRole(
        ...
        allowed_paths=["backend/src/fablemap_api/core/", "frontend/app/", "scripts/", "tests/"],
        deliverables=[
            "Code changes",
    ...
    AgentRole(
        ...
        allowed_paths=["tests/", "backend/src/fablemap_api/core/", "frontend/app/"],
        deliverables=[
